...
class TEXTHANDLER:
    ...
    def GetRandomAlphabetWords(self, numOfChars):
        '''
            Get Random alphabet string of numOfChars
        '''
        bitLength = numOfChars * BYTE_SIZE
        txt = self.__getRandomAlphabetWords(bitLength)
...
if __name__ == '__main__':
    ...
    text =  txtHandler.GetRandomAlphabetWords(8)
