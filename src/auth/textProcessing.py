...
class TEXTHANDLER:
    ...
    def GetRandomAlphabetWords(self, length):
        '''
            Get Random alphabet string of size: length in bytes
        '''
        lengthinBytes = length * BYTE_SIZE
        return self.__getRandomAlphabetWords(lengthinBytes)
...
if __name__ == '__main__':
    ...
    randText =  txtHandler.GetRandomAlphabetWords(8)
    print ("randText: {}".format(randText))
